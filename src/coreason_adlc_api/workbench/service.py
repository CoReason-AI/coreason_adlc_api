...
from coreason_adlc_api.db_models import DraftModel, ArtifactModel
from coreason_adlc_api.workbench.schemas import (
    DraftCreate, DraftResponse, DraftUpdate, ArtifactResponse, PublishRequest, ApprovalStatus
)
from coreason_adlc_api.exceptions import AccessDeniedError, ResourceNotFoundError, DraftLockedError, ComplianceViolationError
...
class WorkbenchService:
    ...
    @governed_execution(
        asset_id_arg="draft_in.project_id",
        signature_arg=None,
        user_id_arg="self.user.id",
        allow_unsigned=True
    ) # type: ignore
